...
interface MapProps {
  dots?: Array<{
    start: {
      logoSize: number; lat: number; lng: number; label?: string; logoSrc?: string; labelOffsetX?: number; labelOffsetY?: number 
};
    end: { lat: number; lng: number; label?: string; logoSrc?: string; logoSize?: number; labelOffsetX?: number; labelOffsetY?: number };
  }>;
  lineColor?: string;
  showLabels?: boolean;
          ...
          return (
            <g key={`points-group-${i}`}>
              ...
              <g key={`start-${i}`}>
                ...
                {showLabels && (dot.start.label || dot.start.logoSrc) && (
                  <motion.g
                  ...
                  >
                    <foreignObject
                      x={startPoint.x - 80 + (dot.start.labelOffsetX ?? 0)}
                      y={startPoint.y - 40 + (dot.start.labelOffsetY ?? 0)}
                      width="160"
                      height="36"
                      className="block"
                    >
              ...
              <g key={`end-${i}`}>
                ...
                {showLabels && (dot.end.label || dot.end.logoSrc) && (
                  <motion.g
                    initial={{ opacity: 0, y: 5 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <foreignObject
                      x={endPoint.x - 80 + (dot.end.labelOffsetX ?? 0)}
                      y={endPoint.y - 40 + (dot.end.labelOffsetY ?? 0)}
                      width="160"
                      height="36"
                      className="block"
                    >
